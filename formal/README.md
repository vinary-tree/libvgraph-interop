...
`contract.sha256` canonically binds all 27 repository-resident proof sources, configurations,
...
`refinement.tsv` maps all 75 extracted invariants to production source or acceptance tests.
...
- 332 release states generated, 236 distinct states at depth 7, and eight expected-failing release
  causal mutants, including an undeclared portable-tool dependency;
